...
def test_align_tsd():
    ...
    peth = nap.compute_perievent(tsd, tref, windowsize=(-10, 10))
...
def test_compute_perievent_windowsize():
    tsd = nap.Tsd(t=np.arange(100), d=np.arange(100))
    tref = nap.Ts(t=np.arange(10, 100, 10))
    peth = nap.compute_perievent(tsd, tref, windowsize=10.0)
...
def test_compute_perievent_with_tsgroup():
    ...
    tref = nap.Ts(t=np.arange(10, 100, 10))
    peth = nap.compute_perievent(tsgroup, tref, windowsize=(-10, 10))
...
def test_compute_perievent_continuous():
    ...
    pe = nap.compute_perievent_continuous(tsd, tref, windowsize=windowsize)
...
def test_compute_perievent_continuous_with_ep():
    ...
    pe = nap.compute_perievent_continuous(tsd, tref, windowsize=windowsize, ep=ep)
