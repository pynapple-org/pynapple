...
class TsGroup(UserDict, _MetadataMixin):
    ...
    **kwargs
    ...
    def to_trial_tensor(
        ...
        (number of group element, number of trial, number of time bins).
        ...
        >>> tensor = group.to_trial_tensor(ep, binsize=1)
        >>> tensor
        ...
        >>> tensor = group.to_trial_tensor(ep, binsize=1, align="end")
        >>> tensor
